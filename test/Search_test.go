...
func TestSearch(t *testing.T) {
	testFunc := func(done chan bool) {
		...
		doc := gokogiri.HtmlParseString("<html><body><div>Hi<div>Mom</div></div></body></html>")
...
func TestSearchRemoval2(t *testing.T) {
	testFunc := func(done chan bool) {
		...
		doc := gokogiri.XmlParseString("<root><div class=\"a\"><div class=\"b\"><div class=\"c\"/></div></div></root>")
		xp := xpath.NewXPath(doc)
		root := doc.RootElement()
...
func TestNilSearch(t *testing.T) {
	testFunc := func(done chan bool) {
		...
		doc := gokogiri.XmlParseString("<root id=\"foo\"><h1></h1></root>")
		xp := xpath.NewXPath(doc)
