...
var (
	ErrSetMetaEncoding = errors.New("Set Meta Encoding failed")
)
...
func (doc *Doc) SetMetaEncoding(encoding string) (err error) {
	if !doc.IsValid() {
		return
	}
